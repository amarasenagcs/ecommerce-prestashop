...
class FrontContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => 'C:\\wamp64\\www\\prestadefault\\modules\\productcomments\\src\\Entity']);
        $d->addExcludePaths([0 => 'C:\\wamp64\\www\\prestadefault\\modules\\productcomments\\src\\Entity/index.php']);
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => 'C:\\wamp64\\www\\prestadefault\\modules\\ps_checkout\\src\\Entity']);
        $e->addExcludePaths([0 => 'C:\\wamp64\\www\\prestadefault\\modules\\ps_checkout\\src\\Entity/index.php']);

        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => 'C:\\wamp64\\www\\prestadefault\\src\\PrestaShopBundle\\Entity']), 'PrestaShop');
        ...
        $a->setProxyDir('C:\\wamp64\\www\\prestadefault/var/cache/prod\\/doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_c04d8f0ecd6cfbb511bf786f102d482c442a0154071642d95f678a3fd5b3d406');
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, 'C:\\wamp64\\www\\prestadefault/var/cache/prod\\/localization');
    }
    ...
    {
        $this->services['prestashop.core.localization.cldr.datalayer.locale_cache'] = $instance = new \PrestaShop\PrestaShop\Core\Localization\CLDR\DataLayer\LocaleCache(${($_ = isset($this->services['prestashop.core.localization.cldr.cache.adapter']) ? $this->services['prestashop.core.localization.cldr.cache.adapter'] : ($this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, 'C:\\wamp64\\www\\prestadefault/var/cache/prod\\/localization'))) && false ?: '_'});
    ...
    {
        return $this->services['ps_checkout.cache.directory'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('1.7.8.7', 'C:\\wamp64\\www\\prestadefault', false);
    }
    ...
    {
        return $this->services['ps_checkout.logger.directory'] = new \PrestaShop\Module\PrestashopCheckout\Logger\LoggerDirectory('1.7.8.7', 'C:\\wamp64\\www\\prestadefault');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.root_dir' => 'C:\\wamp64\\www\\prestadefault/app',
            'kernel.project_dir' => 'C:\\wamp64\\www\\prestadefault',
            'kernel.name' => 'app',
            'kernel.debug' => false,
            'kernel.environment' => 'prod',
            'kernel.cache_dir' => 'C:\\wamp64\\www\\prestadefault/var/cache/prod\\',
            'kernel.active_modules' => [
                ...
                68 => 'wbblocksearch',
                69 => 'wbblog',
                70 => 'wbcategoryfeaturedproducts',
                71 => 'wbfeature',
                72 => 'wbimageslider',
                73 => 'wbimgbanner',
                74 => 'wblogoslider',
                75 => 'wbmegamenu',
                76 => 'wbproductcountdown',
                77 => 'wbstaticblocks',
                78 => 'wbthemeconfigurator',
                79 => 'wbthemecustomizer',
            ],
            'ps_cache_dir' => 'C:\\wamp64\\www\\prestadefault/var/cache/prod\\',
            ...
            'doctrine.orm.proxy_dir' => 'C:\\wamp64\\www\\prestadefault/var/cache/prod\\/doctrine/orm/Proxies',
