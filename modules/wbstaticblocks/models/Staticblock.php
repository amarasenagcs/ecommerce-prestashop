...
class Staticblock extends ObjectModel
{
    ...
    public function getStaticblockLists($id_shop = null, $hook_position = 'displayTop')
    {
        ...
        $object =  Db::getInstance()->executeS(
            'SELECT * FROM '._DB_PREFIX_.'wb_staticblock AS psb 
            LEFT JOIN '._DB_PREFIX_.'wb_staticblock_lang AS psl ON psb.id_wbstaticblock = psl.id_wbstaticblock
            LEFT JOIN '._DB_PREFIX_.'wb_staticblock_shop AS pss ON psb.id_wbstaticblock = pss.id_wbstaticblock
