...
$sql = array();
$sql[] = 'CREATE TABLE IF NOT EXISTS `' . _DB_PREFIX_ . 'wb_staticblock` (
...
$sql[] = 'CREATE TABLE IF NOT EXISTS `' . _DB_PREFIX_ . 'wb_staticblock_lang` (
...
$sql[] = 'CREATE TABLE IF NOT EXISTS `' . _DB_PREFIX_ . 'wb_staticblock_shop` (
            `id_wbstaticblock` int(11) unsigned NOT NULL,
...
foreach ($blocks as $block) {
    ...
    $sql[] = "INSERT INTO `"._DB_PREFIX_."wb_staticblock`
...
foreach ($blocklangs as $blocklang) {
    ...
    $sql[] = "INSERT INTO`"._DB_PREFIX_."wb_staticblock_lang` (`id_wbstaticblock`,`id_lang`,`title`,`description`)
...
foreach ($blockshops as $blockshop) {
    ...
    $sql[] = "insert into `"._DB_PREFIX_."wb_staticblock_shop`(`id_wbstaticblock`, `id_shop`) 
    VALUES('".$id."','".$id_shop."')";
}
