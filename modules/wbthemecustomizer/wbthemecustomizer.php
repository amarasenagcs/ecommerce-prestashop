...
class WbThemeCustomizer extends Module
{
    ...
    public function __construct()
    {
        ...
        $this->description = $this->l('Required by author: Wbthemes.');
    ...
    private function defineArrays()
    {
        ...
        $this->cssRules = array(
            ...
            'WB_mainColorScheme' => array(
                ...
                //default-theme.css
                array(
                    'selector' => '.conditions-box p.new, #footer #newsletter_block_left .form-group .button-small:hover, .wb-demo-wrap .control.inactive, .cl-row-reset .cl-reset, .button.button-small, .button.button-medium, .button.exclusive-medium span, .button.lnk_view span, table#product_comparison .button-container a, #layer_cart .layer_cart_cart .button-container .btn, #commentInput div.submit input:hover',
                    'rule' => 'background-color'
                ),
        
                //Product-list.css
                array(
                    'selector' => '.top-pagination-content .compare-form .button.button-medium, .bottom-pagination-content .compare-form .button.button-medium, #layered_block_left .ui-state-default, #layered_block_left .ui-widget-content .ui-state-default',
                    'rule' => 'background-color'
                ),
                array(
                    'selector' => 'ul.product_list.list > li .learn-more a:hover, .content_sortPagiBar .display li a i, .content_sortPagiBar .display_m li a i, #sdsblogArticle .post-info a:hover',
                    'rule' => 'color'
                ),
        
                //Product.css
                array(
                    'selector' => '#more_info_tabs li a, .box-info-product .exclusive:hover span',
                    'rule' => 'background-color'
                ),
        
                //themes.css
                array(
                    'selector' => '.cart_block .cart-buttons a span, .cart_navigation .button-exclusive, #wbtabproductsisotope .wbtabproductsisotope-filter a, .sdsblog-box-content .sds_blog_post .right_blog_home .r_more, #static_home_top .purchase-now a:hover',
                    'rule' => 'background-color'
                ),
        
                //currencies.css + language.css
                array(
                    'selector' => '#currencies-block-top ul, #languages-block-top ul',
                    'rule' => 'background-color'
                ),

                //wbmegamenu.css
                array(
                    'selector' => '#header_menu, #header_mobile_menu',
                    'rule' => 'background-color'
                ),
                array(
                    'selector' => '.menu-bottom .menu-bottom-dec a:hover',
                    'rule' => 'background-color'
                ),
        
        //wbvmegamenu.css
                array(
                    'selector' => '.v-megamenu-title',
                    'rule' => 'background-color'
                )
        ...
        //themes.css
                array(
                    'selector' => '#search_block_top .btn.button-search.active, #back-top a, .button_purchase a:hover, #wbtabproductsisotope .wbtabproductsisotope-filter a:hover, #wbtabproductsisotope .wbtabproductsisotope-filter a.active, .wb-main-slider .slide-button:hover, .wb-slideshow-container .flex-control-paging li a:hover, .wb-slideshow-container .flex-control-paging li a.flex-active, .nivo-controlNav a:hover, .nivo-controlNav a.active, .sdsblog-box-content .sds_blog_post:hover .right_blog_home .r_more, #static_home_top .purchase-now a',
                    'rule' => 'background-color'
                ),
                array(
                    'selector' => '.static-home-bottom .left_content em, .static-home-bottom .content a:hover, .owl-buttons [class^="carousel-"] span:hover, #testimonials_block_right .prev.bx-prev:hover:before, #testimonials_block_right .next.bx-next:hover:before, .right_blog_home .content h3:hover a',
                    'rule' => 'color'
                ),
        
                //currencies.css + language.css
                array(
                    'selector' => '#currencies-block-top div.current:hover, #languages-block-top div.current:hover',
                    'rule' => 'color'
                ),
                array(
                    'selector' => '#currencies-block-top ul li.selected, #currencies-block-top ul li:hover a, #languages-block-top ul li.selected, #languages-block-top ul li a:hover',
                    'rule' => 'background-color'
                ),
        
                //wbmegamenu.css
                array(
                    'selector' => '.wbmegamenu .demo_custom_link_cms .menu-item.depth-1 > .title a:hover, .custom_link_feature li:hover a, .custom-col-html a, .custom-col-html h4, .wbmegamenu .submenu .title:hover a',
                    'rule' => 'color'
                ),
                array(
                    'selector' => '.wbmegamenu .menu-items',
                    'rule' => 'border-color'
                ),
                array(
                    'selector' => '.wbmegamenu .root:hover .root-item > a > .title, .wbmegamenu .root:hover .root-item > .title, .wbmegamenu .root.active .root-item > a > .title, .wbmegamenu .root.active .root-item > .title, .wbmegamenu .root .root-item > a.active > .title, .wbmegamenu > ul > li.demo_other_menu, .menu-bottom .menu-bottom-dec a',
                    'rule' => 'background-color'
                ),
        
        //wbvmegamenu.css
                array(
                    'selector' => '.v-megamenu > ul > li:hover a.menu-title, .v-megamenu > ul > li.more-vmegamenu:hover a',
                    'rule' => 'background-color'
                ),
                array(
                    'selector' => '.v-megamenu > ul > li:hover a.menu-item-title:hover, main .v-main-section-sublinks li a:hover',
                    'rule' => 'color'
                )
