            ...
            <div class="cl-container">
                <div class="cl-table">
                    ...
                    <div class="cl-tr cl-tr-style">
                        <div class="cl-td-l cl-td-layout cl-td-layout1"><a href="javascript:void(0)" id="5f2600_222222" title="Strong pink_dark gray"><span class="tcbrown"></span><span class="tceb5f60"></span>{l s='Skin 1' mod='wbthemecustomizer'}</a></div>
                    </div>
                    <!-- 2 -->
                     <div class="cl-tr cl-tr-style">
                        <div class="cl-td-r cl-td-layout cl-td-layout2"><a href="javascript:void(0)" id="725843_222222" title="lime green_Vivid yellow"><span class="tcred"></span><span class="tcyellow"></span>{l s='Skin 2' mod='wbthemecustomizer'}</a></div>
                    </div>
                <!-- 3 -->
                    <div class="cl-tr cl-tr-style">
                    ...
                    <!-- 5 -->
                    <div class="cl-tr cl-tr-style">
                        <div class="cl-td-l cl-td-layout cl-td-layout5"><a href="javascript:void(0)" id="4F7CAC_222222" title="Bright pink_dark blue"><span class="tcpink"></span><span class="tcblue"></span>{l s='Skin 5' mod='wbthemecustomizer'}</a></div>
                    </div>
                    <!-- 6 -->
                     <div class="cl-tr cl-tr-style">
