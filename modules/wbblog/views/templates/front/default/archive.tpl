	...
	<div class="kr_blog_post_area undblg">
		<div class="kr_blog_post_inner blog_style_{$wbblogsettings.blog_style} column_{$wbblogsettings.blog_no_of_col}">
			{foreach from=$wbblogpost item=xpblgpst}
				<article id="blog_post" class="archb blog_post_{$xpblgpst.post_format} clearfix row">
						...
						<div class="blog_post_content_bottom allbl col-lg-6 col-md-12 col-xs-12">
									
							<h3 class="post_title"><a href="{$xpblgpst.link}">{$xpblgpst.post_title|truncate:70:'...'}</a></h3>
							<div class="blogdl"><span>{$xpblgpst.post_author_arr.firstname} {$xpblgpst.post_author_arr.lastname}</span> <div class="d-inline-block"> | </div>
									<span>{$xpblgpst.post_date|date_format:"%b %dth, %Y"}</span></div>
