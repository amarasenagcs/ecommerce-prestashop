...
{$id_lang = Context::getContext()->language->id}
	<div id="pt_vegamenu" class="title-menu wr-left-menu hidden-sm-down">
		<div id="wr-menu-icon">
          <div class="wr-menu">              
              <span class="cate">{l s='menu' d='Shop.Theme.Catalog' mod='wbmegamenu'}</span>
          </div>
     	</div>
    </div>
											...
											<div class="wb-menu-col col-xs-12 {$menu_col.width|escape:'html':'UTF-8'} {$menu_col.class|escape:'html':'UTF-8'} {$menu.type|escape:'quotes':'UTF-8'}">
												{if count($menu_col.list_menu_item) > 0}
													...
													{foreach from=$menu_col.list_menu_item item= sub_menu_item name=sub_menu_item}
														<li class="menu-item {if $sub_menu_item.type_item == 1} item-header bh{else} item-line{/if} {if $sub_menu_item.type_link == 4}product-block{/if}">
