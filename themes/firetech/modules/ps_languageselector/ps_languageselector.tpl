 ...
 *}
<li id="_desktop_language_selector" class="d-inline-block">
  <div class="language-selector-wrapper">
    <div class="language-selector dropdown js-dropdown">
      {* <span id="Language-selector-label" class="label">{l s='Language:' d='Shop.Theme.Global'}</span> *}
      <button data-toggle="dropdown" class="hidden-sm-down btn-unstyle f1" aria-haspopup="true" aria-expanded="false" aria-label="{l s='Language dropdown' d='Shop.Theme.Global'}">
