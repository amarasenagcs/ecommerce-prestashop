...
<li id="_desktop_currency_selector" class="d-inline-block">
  ...
  {*   <span id="Language-selector-label" class="label">{l s='Currency:' d='Shop.Theme.Global'}</span> *}
    <button data-target="#" data-toggle="dropdown" class="hidden-sm-down btn-unstyle f1" aria-haspopup="true" aria-expanded="false" aria-label="{l s='Currency dropdown' d='Shop.Theme.Global'}">
