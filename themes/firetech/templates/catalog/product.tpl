 ...
 {block name='hook_display_reassurance'}
            ...
            {block name='product_tabs'}
                ...
                <ul class="nav nav-tabs" role="tablist">
                  ...
                  {/foreach}
                  <li class="nav-item">
                      <a class="nav-link" href="#rate" data-toggle="tab" role="tab" id="rv"> {l s='Review' d='Shop.Theme.Catalog'}</a>
                  </li>
                </ul>
                ...
                <div class="tab-pane fade in" id="rate" role="tabpanel">
                  {hook h='displayWbProductTabContent' product=$product}
                 </div>
    ...
    {block name='product_accessories'}
      {if $accessories}
        <section class="product-accessories clearfix prelated tabpro home-tabs ">
           <div class="pro-tab other">
                 <div class="home-heading"> <span>{l s='Related Product' d='Shop.Theme.Catalog'}</span></div>
            </div>
