    ...
    {foreach $stores as $store}
      <article id="store-{$store.id}" class="store-item card">
        <div class="store-item-container clearfix">
          <div class="col-lg-3 col-md-2 store-picture hidden-sm-down">
            <img src="{$store.image.bySize.stores_default.url}" alt="{$store.image.legend}" title="{$store.image.legend}">
          </div>
          <div class="col-md-5 col-sm-5 col-xs-12 store-description">
          ...
          <div class="col-lg-4 col-md-5 col-sm-7 col-xs-12 divide-left">
            <table>
